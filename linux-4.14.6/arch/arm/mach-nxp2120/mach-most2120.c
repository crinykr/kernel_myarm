...
#elif defined(CONFIG_MODEL_RK_HIT_L)
	#define CFG_SYS_CPU_NAME "RK_HIT_L"

#elif defined(CONFIG_MODEL_RK_HIT_3DSENS)
	#define CFG_SYS_CPU_NAME "RK_HIT_3DSENS"

#elif defined(CONFIG_MODEL_RK_HIT_N)
	#define CFG_SYS_CPU_NAME "RK_HIT_N"

#elif defined(CONFIG_MODEL_RK_HIT_SUPERNOVA)
	#define CFG_SYS_CPU_NAME "RK_HIT_SUPERNOVA"

#elif defined(CONFIG_MODEL_AE)
	#define CFG_SYS_CPU_NAME "AE"

#elif defined(CONFIG_MODEL_AE_AUDIO)
	#define CFG_SYS_CPU_NAME "AE AUDIO"

#elif defined(CONFIG_MODEL_AE_AUDIO2)
	#define CFG_SYS_CPU_NAME "AE AUDIO 2"

#elif defined(CONFIG_MODEL_RK_HIT_OV7675)
	#define CFG_SYS_CPU_NAME "AE AUDIO"

#elif defined(CONFIG_MODEL_RK_HIT_VI)
	#define CFG_SYS_CPU_NAME "RK_HIT_VI"

#elif defined(CONFIG_MODEL_VISION_MOTOR)
	#define CFG_SYS_CPU_NAME "VISION_MOTOR"

#elif defined(CONFIG_MODEL_RK_HIT_SUPERNOVA)
	#define CFG_SYS_CPU_NAME "RK_HIT_SUPERNOVA"

#elif defined(CONFIG_MODEL_USB_CAMERA)
	#define CFG_SYS_CPU_NAME "USB CAMERA"
...
static void __init cpu_map_io(void)
{
	...
	boot_alloc_mem = 0xA0000000; /* Start of the DRAM/BLOCK address */
#else
#if defined(CONFIG_NEXELL_V_MEM)
	boot_alloc_mem = CFG_MEM_PHY_SYSTEM_BASE + CFG_MEM_PHY_SYSTEM_SIZE + 16 * 1024 * 1024; //test
#else
