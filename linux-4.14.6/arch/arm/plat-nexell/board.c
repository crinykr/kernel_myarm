...
{
    char	*memory_strength_name[] = { "Normal",
    									"Weak" };
    char	*memory_odt_name[] = { "Disable",
    							   "75",
    							   "150",
    							   "50",
    							  };

    char	*nxp2120_strength_name[] = { "300",
										 "150",
										 "100",
										 "75",
										 "60",
	...
	*/
	...
	NX_MCUD_SetDIC( NX_MCUD_DIC_NORMAL);		// DDR Memory PAD Strength
	...
	/* Set Phy's ODT */
	NX_MCUD_PHYZQ_SetODT( NX_MCUDPHY_ODT_DISABLE );  // NXP2120 DDR PAD ODT (Default 75)
#else
...
#endif
#endif
	printk ("DDR Memory PAD(STR=%s ODT=%s), NXP2120 DDR PAD(STR=%s ODT=%s)\n",
			 memory_strength_name[NX_MCUD_GetDIC()],
			 memory_odt_name[NX_MCUD_GetODT()],
			 nxp2120_strength_name[NX_MCUD_PHYZQ_GetDIC()],
			 nxp2120_odt_name[NX_MCUD_PHYZQ_GetODT()] );
