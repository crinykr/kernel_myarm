 ...
 * SPI platform device
 */
#if defined(CONFIG_SPI_NEXELL)

struct spi_io_cs spi_css[1] ={
	{
		.pad = (0x0000 << 16) | 28, /* port A, bit 28 */
        .func = 0,
    },
};

static struct spi_plat_data spi_data0 = {
	.port = 0,
	.irq = IRQ_PHY_SSPSPI0,
	.cs_num = 1,
	.io_cs = &spi_css[0],
...
static struct platform_device spi_plat_device = {
	...
	.id		= 0,
	.dev 	= {
		.platform_data = &spi_data0,
	},
};
#endif	/* CONFIG_SPI_NEXELL */
...
struct ov7675_i2c_platform_data ov7675_data= {
    .id = 0,
    .i2c_name = "ov7675",
    .device_name = "OV7675",
};

struct ov7675_i2c_platform_data ov7675_2_data= {
    .id = 1,
    .i2c_name = "ov7675_2",
    .device_name = "OV7675_2",
};
*/
...
static struct i2c_board_info i2c_devs0[] __initdata = {
	...
	{ I2C_BOARD_INFO("ov7675", 0x21),},//  .platform_data = &ov7675_data},
#if defined(CONFIG_SND_SOC_CX20709)
	{ I2C_BOARD_INFO("cx20709",  0x14),},
#endif
#if defined(CONFIG_MODEL_RK_HIT_N) && defined(CONFIG_SND_SOC_CX20865)
	{ I2C_BOARD_INFO("cx20865",  0x47),},
#endif
...
#if !defined(CONFIG_SND_SOC_CX2074X_CX20865) && !defined(CONFIG_SND_SOC_CX2074X)
	{ I2C_BOARD_INFO("wm8960_2", 0x1a),},
#endif
#if defined(CONFIG_SND_SOC_CX2074X_CX20865) || defined(CONFIG_SND_SOC_CX2074X) || defined(CONFIG_SND_SOC_CX2074X_CX20865_MODULE) || defined(CONFIG_SND_SOC_CX2074X_MODULE) || \
	defined(CONFIG_SND_SOC_CX2074X_CX20922) || defined(CONFIG_SND_SOC_CX2074X_CX20922_MODULE)
	{ I2C_BOARD_INFO("cx2074x",  0x4A),},	// To data sheet is 0x14.
#endif
#if !defined(CONFIG_MODEL_RK_HIT_N) && (defined(CONFIG_SND_SOC_CX2074X_CX20865) || defined(CONFIG_SND_SOC_CX20865) || defined(CONFIG_SND_SOC_CX2074X_CX20865_MODULE) || defined(CONFIG_SND_SOC_CX20865_MODULE))
	{ I2C_BOARD_INFO("cx20865",  0x47),},
#endif
#if defined(CONFIG_SND_SOC_CX2074X_CX20922) || defined(CONFIG_SND_SOC_CX20922) || defined(CONFIG_SND_SOC_CX2074X_CX20922_MODULE) || defined(CONFIG_SND_SOC_CX20922_MODULE)
	{ I2C_BOARD_INFO("cx20922",  0x41),},
#endif
	{ I2C_BOARD_INFO("hi161_2",  0x20),},
	{ I2C_BOARD_INFO("ov7675_2", 0x21),},// .platform_data = &ov7675_2_data},
	//{ I2C_BOARD_INFO("mt9m114_2", 0x90>>1), },
};
...
#include <cfg_sf_part_map.h>
struct flash_platform_data sf_plat = {
	.name = "nxp2120_sf",
	.type = "w25q128",
	.parts = sf_partition_map,
	.nr_parts = ARRAY_SIZE(sf_partition_map),
};
#endif
static struct spi_board_info nxp2120_spi_devices[] __initdata = {
...
#if defined(CONFIG_MTD_M25P80)
	{
        ...
        .bus_num    = 0,
        .mode = SPI_MODE_3,
        .platform_data = &sf_plat,
    },
#endif
#if defined(CONFIG_PANASONIC_MN63Y1210)	
    {
        .modalias    = "mn63y1210",
        .chip_select    = 0,
        .max_speed_hz    = 1 * 1000 * 1000,
...
#if defined(CONFIG_V4L2_DRIVER_NEXELL_MODULE0)
int vip0_cfg_gpio(void)
{
    struct	NX_GPIO_RegisterSet *gpioa, *gpiob;
	...
	defined(CONFIG_MODEL_RKSII_VR_MALE) || defined(CONFIG_MODEL_RKSII_VI) || defined(CONFIG_MODEL_RKN) || \
	defined(CONFIG_MODEL_RK_HIT_3DSENS) || defined(CONFIG_MODEL_AE) || defined(CONFIG_MODEL_AE_AUDIO) || \
	defined(CONFIG_MODEL_AE_AUDIO2) || defined(CONFIG_MODEL_RK_HIT_V2_AUDIO2)

	gpioa->GPIOxALTFN[1] = gpioa->GPIOxALTFN[1] & 0xFCFFFFFF; /* GPIOA 28  to GPIO*/
	gpioa->GPIOxOUTENB = gpioa->GPIOxOUTENB | 0x10000000;
	gpioa->GPIOxOUT = gpioa->GPIOxOUT & ~0x10000000;

#elif defined(CONFIG_MODEL_RK_HIT_V2) || defined(CONFIG_MODEL_RK_HIT_V4) || defined(CONFIG_MODEL_RK_HIT_L) || \
	  defined(CONFIG_MODEL_RK_HIT_OV7675) || defined(CONFIG_MODEL_RK_HIT_VI)
 
	gpiob->GPIOxALTFN[0] = gpiob->GPIOxALTFN[0] & 0xCFFFFFFF; /* GPIOB 14  to GPIO*/
	gpiob->GPIOxOUTENB |= 0x4000;
	gpiob->GPIOxOUT &= ~0x4000;

#elif defined(CONFIG_MODEL_RK_HIT_N)

	gpioa->GPIOxALTFN[0] = gpioa->GPIOxALTFN[0] & 0xFFFFFCFF; /* GPIOA 4  to GPIO*/
	gpioa->GPIOxOUTENB |= 0x00000010; // GPIOA[4] for OUTPUT
	gpioa->GPIOxOUT &= ~0x00000010; // GPIOA[4] clear
#endif
...
//    printk("GPIOA FN1 = %x\n", gpioa->GPIOxALTFN[1]);
#else
	gpioa->GPIOxALTFN[1] &= 0xFCFFFFFF;
	gpioa->GPIOxOUTENB	|= 0x10000000;
	gpioa->GPIOxOUT = gpioa->GPIOxOUT & ~0x10000000;
#endif
...
#elif defined(CONFIG_MODEL_RK_HIT_V2) || defined(CONFIG_MODEL_RK_HIT_V4) || defined(CONFIG_MODEL_RK_HIT_L) || \
	  defined(CONFIG_MODEL_RK_HIT_OV7675) || defined(CONFIG_MODEL_RK_HIT_VI) || defined(CONFIG_MODEL_RK_HIT_SUPERNOVA)

	gpiob->GPIOxOUTENB |= 0x4000;
	
	if (reset)
		gpiob->GPIOxOUT = gpiob->GPIOxOUT |  0x4000;	// GPIOB[14]
	else
		gpiob->GPIOxOUT = gpiob->GPIOxOUT & ~0x4000;// GPIOB[14]

#elif defined(CONFIG_MODEL_RK_HIT_N) || defined(CONFIG_MODEL_VISION_MOTOR)
	gpioa->GPIOxOUTENB |= 0x00000010; // GPIOA[4] for OUTPUT
	
	if (reset)
		gpioa->GPIOxOUT = gpioa->GPIOxOUT | 0x00000010;
	else
		gpioa->GPIOxOUT = gpioa->GPIOxOUT & ~0x00000010;
#else
...
int vip1_gpio_reset(int reset)
{
    ...
    gpioa = (struct NX_GPIO_RegisterSet *)(IO_ADDRESS(PHY_BASEADDR_GPIO));
...
static struct nx_platform_vip v4l2_platdata0 = {
	...
	.buff_count		= 4,
	.skip_count		= 3,
#if defined(CONFIG_NEXELL_LASER_CONTROL0)
	.laser_ctrl		= 1,
#else
	.laser_ctrl		= 0,
#endif
...
static struct nx_platform_vip v4l2_platdata1 = {
	...
	.buff_count		= 4,
	.skip_count		= 3,
#if defined(CONFIG_NEXELL_LASER_CONTROL1)
	.laser_ctrl		= 1,
#else
	.laser_ctrl		= 0,
#endif
...
/* MISC */
	...
	spi_register_board_info(nxp2120_spi_devices, ARRAY_SIZE(nxp2120_spi_devices));
#endif
